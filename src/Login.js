    ...
    <div className="d-flex flex-column vw-100 vh-100 align-items-center justify-content-center bg-secondary">
      <div className="row w-75">
        <div className="col-6">
          ...
          <h3 className="mt=5">
            Reach the people you love at the touch of your fingertips
          </h3>
        </div>
        <div className="col-6">
          <form className="d-flex flex-column container form-group bg-light p-5">
            ...
            ></input>
            <Button
              handleClick={sendInfo}
              text={"Log In"}
              className={
                "btn btn btn-primary align-self-center btn-block w-100 mt-3"
              }
            />
            ...
            <Button
              ...
              text={"Sign Up"}
              className={
                "btn btn btn-success align-self-center btn-block w-100"
              }
            />
          </form>
        </div>
